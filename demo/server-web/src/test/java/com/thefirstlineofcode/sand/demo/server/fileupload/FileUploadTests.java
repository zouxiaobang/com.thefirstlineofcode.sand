...
import com.thefirstlineofcode.sand.demo.server.fileupload.storage.StorageException;
...
public class FileUploadTests {
	private static final Path DOWNLOAD_DIR = Paths.get("download-dir");
	...
	private Request getFileUploadRequest() {
		...
		return new Request.Builder().url("http://localhost:" + port).post(requestBody).build();
	}
}
